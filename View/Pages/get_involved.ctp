...
<div class="row">
	<h1>
		<?php echo __('Get Involved!'); ?>
	</h1>
	<p>
		<?php echo __('If you\'re interested in contributing to <strong>CakePHP</strong> and supporting the community then we\'d love for you to join us, there are a variety of ways to get involved and help out.'); ?>
	</p>
	<h2>
		<?php echo __('User Support'); ?>
	</h2>
	<p>
		<?php echo __('One of the greatest ways to contribute to <strong>CakePHP</strong> is by directly supporting the developer community. There\'s no need to be a genius or guru to get involved, you may just have the answer to some of the questions being asked. Here are some ways you can get started:'); ?>
	</p>
	<ul>
		<li>
	...
	<p>
		<?php echo __('Helping others to learn <strong>CakePHP</strong> is another valuable way to contribute to the community. There are many ways you can help others, these include:'); ?>
	</p>
	<ul>
		<li>
			<?php echo __('Coding Seminars'); ?>
		</li>
		<li>
			<?php echo __('Live Workshops'); ?>
		</li>
		<li>
			<?php echo __('Hackathons'); ?>
		</li>
		<li>
			<?php echo __('Training Courses'); ?>
		</li>
		<li>
	...
	<p>
		<?php echo __('Additionally, we offer professional <a href="http://training.cakephp.org" target="_blank" title="CakePHP training">training</a> for <strong>CakePHP</strong>, as well as the opportunity to become an officially certified <strong>CakePHP</strong> developer through the developer certification program.'); ?>
	</p>
	<h2>
		<?php echo __('Marketing and Evangelism'); ?>
	</h2>
	<p>
		<?php echo __('As an open source project, backed by the <a href="http://cakefoundation.org" target="_blank" title="Cake Software Foundation">Cake Software Foundation, Inc</a>, we don\'t have a massive budget to market and advertise the framework, so we depend on people like <em style="text-decoration: underline;">you</em> getting involved and helping support the community. There are many actions which can help raise awareness, share experiences and educate your fellow developers about <strong>CakePHP</strong>.'); ?>
	</p>
	<h3>
		<?php echo __('Write and Talk About CakePHP'); ?>
	</h3>
	<p>
		<?php echo __('Actively writing and talking about <strong>CakePHP</strong> helps spread the word about the framework.'); ?>
	</p>
	<ul>
		<li>
			<?php echo __('Write an article or blog post about a certain feature or development experience.'); ?>
		</li>
		<li>
			<?php echo __('Comment on articles or posts and provide ideas and arguments which invite further conversation and feedback.'); ?>
		</li>
		<li>
			<?php echo __('Use social platforms such as <a href="http://www.facebook.com/groups/cake.community" target="_blank" title="Official CakePHP Group on Facebook">Facebook</a>, <a href="http://goo.gl/mSC0s" target="_blank" title="Official CakePHP Community on Google Plus">Google+</a> or <a href="http://twitter.com/CakePHP" target="_blank" title="CakePHP on Twitter">Twitter</a> to provide links to articles, posts, plugins, events, etc.'); ?>
		</li>
	</ul>
	<h3>
		<?php echo __('Help Your Local Community'); ?>
	</h3>
	<p>
		<?php echo __('We depend on people who know and understand their local community. This not only refers to the difference in the language, but also the local customs and cultural differences. You can help us by connecting with your local community and supporting <strong>CakePHP</strong>. A few actions you can undertake include:'); ?>
	</p>
	<ul>
		<li>
			<?php echo __('Starting or joining a local user group'); ?>
		</li>
		<li>
			<?php echo __('Organizing events or meet-ups'); ?>
		</li>
		<li>
	...
	<p>
		<?php echo __('Patch files should be either in unified diff files, or generated with git format-patch.'); ?>
	</p>
	<h3>
		<?php echo __('Contributing via Commits on a GitHub Fork.'); ?>
	</h3>
	<p>
		<?php echo __('Contributing via commits on a <a href="http://github.com/cakephp/cakephp" target="_blank" title="Official CakePHP repository on GitHub">GitHub</a> fork is the preferred way of submitting fixes. If your fix is more than a single commit, you should put the fix on an appropriately named branch. This makes integration of the fix easier.'); ?>
	</p>
	<h2>
	...
	<p>
		<?php echo __('Sometimes there are problems in <strong>CakePHP</strong>. If you think you\'ve come across one you can:'); ?>
	</p>
	<ul>
		<li>
	...
	<p>
		<?php echo __('We have developers from countries all over the world who use <strong>CakePHP</strong>. If you\'re a non-english speaker, translating the <a href="http://api.cakephp.org" target="_blank" title="CakePHP API">API</a> or the <a href="http://book.cakephp.org" target="_blank" title="CakePHP CookBook">CookBook</a> content into your language is another way to help support the community. Providing the official documentation and support material in as many languages as possible helps lower the barrier to entry to using the framework.'); ?>
	</p>
	<br/>
</div>
